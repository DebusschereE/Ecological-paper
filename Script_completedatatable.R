...
#1.Flowcam: phytoplankton groups (100 - 300µm)
#2.Zooscan: zooplankton groups (300 - 2000µm)
#3.FCM (vliz): size groups of Phytoplankton (<800µm)
#4.Pigment data transformed via chemtax to phytoplankton groups
#5.Abiotic parameters derived from the underway system of the RV Simon Stevin
