...
#
df=t[,c(3:4, 5:10, 159:161,72,75:76 ,127,99:106)]
rownames(df)
df=df[-37,]
...
#Here, keep 3 axes
pcaz=dudi.pca(log(zoo),scale=F)


#Eigenvalues expressed in 58%
...
test
#non-significant permutation test: siginficant relationship between zooplankton and abiotic parameters
plot(test)
