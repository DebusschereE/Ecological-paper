...
# Load NGS data ####
otu_18s = read.table("NGS/otu_table_18S_max1.txt", header = T, sep = "")
...
otu_16s = read.table("NGS/otu_table_16S_max1.txt", header = T, sep = "")
otu_16s[ , c(2:53)] = lapply(otu_16s[ , c(2:53)], as.numeric)
tax_18s = read.table("NGS/tax18.csv", header = T, sep = ";")
tax_16s = read.table("NGS/tax16.csv", header = T, sep = ";")
# Data manipulation
