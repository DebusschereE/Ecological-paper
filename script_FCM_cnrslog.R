...
#
df=t[,c(3:4, 5:10, 159:161,72,75:76 ,127,91:98)]
...
cor(abio,pcaz$li)
##Salinity, T, NH4, SiO2, N.P.Si have the highest correlation with axis 1
##N.P seems to be correlated with Axis 2
##NO2 with axis3
#visualisations:
#axes 1 and 2:
par(mfrow=c(3,3))
...
s.arrow(sup,clab=1.5,xlim=c(-50,40))
s.arrow(iv.mem$c1,clab=1.5,xlim=c(-1.2,0.4))
